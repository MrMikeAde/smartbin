    ...
    public class AutomaticProtectionEngine
    {
        ...
        public async Task RunAutomaticProtectionAsync(CancellationToken cancellationToken = default)
        {
            try
            {
                ...
                {
                    _failureInjector.Check("NotificationFailure");
                ...
                _failureInjector.Check("StorageMonitoringFailure");
            ...
            {
                // Prevent background protection loop from crashing the application / background task
                try
                {
                    _notificationService.RaiseNotification($"Automatic protection background error: {ex.Message}", "Error");
                }
